...
public class WebTableOrder_step_def {
    ...
    public void user_enters_quantity(Integer int1) {
        //there was a default number on here. it needs tobe cleared first to input our own value
        webTableOrderPage.inputQuantity.clear();

        //you need to concat int value with a string "" to be able to use sendKeys
